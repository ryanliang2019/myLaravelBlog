        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
					...
					-->
					<textarea name="article_content" id="article_content" style="width:860px;height:500px;">@if(isset($article->article_content)){!! $article->article_content !!}@endif</textarea>
